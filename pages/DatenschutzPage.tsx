...
const sections = [
  ...
  {
    id: 'maps',
    title: '4. Karten- und Routenservices',
    icon: MapPinned,
  },
  {
    id: 'schriftarten',
    ...
    <div className="min-h-screen bg-neutral-50 pt-28 pb-24">
      <div className="mx-auto max-w-6xl px-6 md:px-12">
        <motion.header
          ...
          className="mb-10 grid gap-6 lg:grid-cols-3 lg:items-stretch"
        >
          ...
          <div className="flex h-full flex-col justify-center rounded-2xl border border-neutral-200 bg-white p-6 text-sm leading-relaxed text-neutral-600 shadow-sm lg:col-span-1">
          ...
          {sections.map((item, index) => {
            ...
            return (
              <motion.a
                ...
                className="group flex h-full items-center gap-4 rounded-2xl border border-neutral-200 bg-white p-4 shadow-sm transition hover:border-neutral-300 hover:bg-neutral-50"
              >
        ...
        <div className="space-y-6 text-sm leading-relaxed text-neutral-600">
          <section id="verantwortlicher" className="scroll-mt-28 rounded-2xl border border-neutral-200 bg-white p-7 shadow-sm md:p-8">
            <h2 className="text-2xl font-semibold text-neutral-950">1. Verantwortlicher</h2>
            <p className="mt-5">
            ...
            <div className="mt-6 grid gap-5 md:grid-cols-2">
              <div className="h-full rounded-2xl border border-neutral-200 bg-neutral-50 p-5">
                <p className="font-semibold text-neutral-950">Kfz-Werkstatt Lindner</p>
                <p className="mt-3 text-neutral-600">
                  ...
                  <br />
                  Telefon:{' '}
                  <a href="tel:+49309131252" className="font-medium text-neutral-950 underline underline-offset-4">
                    +49 30 913 12 52
                  </a>
                  <br />
                  E-Mail:{' '}
                  <a href="mailto:info@kfz-lindner.de" className="font-medium text-neutral-950 underline underline-offset-4">
                    info@kfz-lindner.de
                  </a>
                </p>
              </div>
              <div className="h-full rounded-2xl border border-neutral-200 bg-neutral-50 p-5">
                <p className="font-semibold text-neutral-950">Autoservice Lindner GmbH</p>
                <p className="mt-3 text-neutral-600">
          ...
          <section id="hosting" className="scroll-mt-28 rounded-2xl border border-neutral-200 bg-white p-7 shadow-sm md:p-8">
          ...
          <section id="kontakt" className="scroll-mt-28 rounded-2xl border border-neutral-200 bg-white p-7 shadow-sm md:p-8">
          ...
          <section id="maps" className="scroll-mt-28 rounded-2xl border border-neutral-200 bg-white p-7 shadow-sm md:p-8">
            <h2 className="text-2xl font-semibold text-neutral-950">4. Karten- und Routenservices</h2>
            <p className="mt-5">
            ...
            <p className="mt-4">
              Rechtsgrundlage für das Laden der eingebetteten Karte ist Ihre Einwilligung nach Art. 6 Abs. 1
            ...
            <p className="mt-4">
              In der mobilen Sticky-Leiste bieten wir außerdem direkte Routenlinks zu Google Maps
              und Apple Karten an. Diese externen Dienste werden erst aufgerufen, wenn Sie die
              jeweilige Option aktiv auswählen. Danach gelten die Datenschutzbedingungen des
              ausgewählten Kartenanbieters. Dabei können insbesondere Zieladresse, IP-Adresse,
              Geräte- und Browserdaten sowie - je nach Einstellungen des Dienstes oder Endgeräts -
              Standort- und Routendaten verarbeitet werden.
            </p>
            <p className="mt-4">
              ...
              {' '}sowie in den Datenschutzhinweisen zu Apple Karten:{' '}
              <a
                href="https://www.apple.com/de/legal/privacy/data/de/apple-maps/"
                target="_blank"
                rel="noopener noreferrer"
                className="font-medium text-neutral-950 underline underline-offset-4"
              >
                apple.com/de/legal/privacy/data/de/apple-maps
              </a>
              .
            </p>
          </section>

          <section id="schriftarten" className="scroll-mt-28 rounded-2xl border border-neutral-200 bg-white p-7 shadow-sm md:p-8">
          ...
          <section id="rechte" className="scroll-mt-28 rounded-2xl border border-neutral-200 bg-white p-7 shadow-sm md:p-8">
          ...
          <section id="sicherheit" className="scroll-mt-28 rounded-2xl border border-neutral-200 bg-white p-7 shadow-sm md:p-8">
            <h2 className="text-2xl font-semibold text-neutral-950">7. Sicherheit und Aktualität</h2>
            <p className="mt-5">
